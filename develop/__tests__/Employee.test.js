...
describe("Employee class", () => {
  ...
  it ('should have a getName() function that can be called after instantiation', () => {
    const employee = new Employee('Dave', 1, 'Dave@gmail.com');
    expect(employee.getName(1)).toBe('Dave');
  })

  it ('should have a getId() function that can be called after instantiation', () => {
    const employee = new Employee('Dave', 1, 'Dave@gmail.com');
    expect(employee.getId('Dave')).toBe(1);
  })

  it ('should have a getEmail() function that can be called after instantiation', () => {
    const employee = new Employee('Dave', 1, 'Dave@gmail.com');
